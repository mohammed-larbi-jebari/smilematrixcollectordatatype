...
class smileMatrix
{
    /*!
     Constructor
    */
    function smileMatrix( $name, $numRows = false, $matrixColumnDefinition = false )
    {
        $this->Name = $name;
        $this->Matrix = array();
    ...
    */
    ...
    /*!
        Adds column \a $columnDefinition to smileMatrix object.
    */
    ...
    /*!
        Adds column \a $columnDefinition to 'matrix' member of smileMatrix.
    */
    ...
    /*!
        Adds column \a $columnDefinition to 'cells' member of smileMatrix.
    */
    ...
    */
    ...
    /*!
        Checks current smileMatrix object against definition.
        If columns ids are wrong or
           there are additional/redundant columns in definition/smileMatrix object
    ...
    */
    ...
    /*!
        Removess column \a $columnDefinition from smileMatrix object.
    */
    ...
    /*!
        Removess column \a $columnDefinition from 'cells' member of smileMatrix.
    */
    ...
    /*!
        Removess column \a $columnDefinition from 'matrix' member of smileMatrix.
    */
    ...
    */
    function xmlString()
    {
        ...
        $root = $doc->createElement( "smileMatrix" );
